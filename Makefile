...
NORMAL_ASS_O_FILES = build/main.o build/apply.o build/artifact.o build/attrib.o build/ball.o \
  ...
  build/quest.o build/questpgr.o build/read.o build/rect.o build/region.o build/restore.o build/rnd.o \
  ...
  build/version.o build/util.o build/stdout_msg.o build/move.o build/util_list.o

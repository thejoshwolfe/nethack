...
static struct bill_x *onbill(struct obj *, struct monst *, bool);
static struct monst *next_shkp(struct monst *, bool);
...
static long cost_per_charge(struct monst *,struct obj *,bool);

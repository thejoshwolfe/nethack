 ...
 */
void 
map_background (register signed char x, register signed char y, register int show)
{
 ...
 */
void 
map_invisible (register signed char x, register signed char y)
{
...
STATIC_OVL void 
display_monster (
    register signed char x,
    register signed char y,	/* display position */

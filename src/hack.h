...
enum KillerMethod {
    ...
    KM_LAND_MINE,
    KM_FELL_INTO_PIT,
    KM_FELL_INTO_PIT_OF_IRON_SPIKES,
    KM_RUSTING_AWAY,
    KM_SUFFOCATION,
    KM_STRANGULATION,
    KM_TURNED_INTO_GREEN_SLIME,
    KM_PETRIFICATION,
    KM_TELEPORTED_OUT_OF_THE_DUNGEON_AND_FELL_TO_DEATH,
    KM_WENT_TO_HEAVEN_PREMATURELY,
    KM_COMMITTED_SUICIDE,
    KM_SLIPPED_WHILE_MOUNTING_M,

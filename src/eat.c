...
static const char *
food_xname (struct obj *food, bool the_pfx)
{
        const char *result;
 ...
 */
static void
choke ( /* To a full belly all food is bad. (It.) */
    struct obj *food
)
{
...
static bool 
maybe_cannibal (int pm, bool allowmsg)
{
...
bool 
maybe_finished_meal (bool stopping)
{
